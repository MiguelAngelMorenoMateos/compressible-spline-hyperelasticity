function norms = sparsity_norms(model)
    ...
    if model.use_I1J
        ...
        L2_h_norm = norm(h_ctrl)/model.nh;
        L2_g_norm = norm(g_ctrl)/model.ng;
    ...
    if model.use_I2J
        ...
        L2_j_norm = norm(j_ctrl)/model.nj; 
        L2_i_norm = norm(i_ctrl)/model.ni;
    ...
    if model.use_I1I2
        ...
        L2_k_norm = norm(k_ctrl)/model.nk;
        L2_l_norm = norm(l_ctrl)/model.nl;
